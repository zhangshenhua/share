...
/**************** structure *********************/
typedef struct _hPUSHBUTTON_OPS{
	...
	* Return : 
	************************************************************************/
	void			(*set_text)(HPushButton *p_Me, const char *pc_str);
	...
	* Return : 
	************************************************************************/
	void			(*set_text_point)(HPushButton *p_Me, short s_x, short s_y);
	...
	* Return : 
	************************************************************************/
	void			(*set_text_mid)(HPushButton *p_Me, int i_ismid);
	...
	* Return : 
	************************************************************************/
	void			(*set_button_autosize_image)(HPushButton *p_Me, int i_isautosize);
	...
	* Return : 
	************************************************************************/
	void			(*set_image_from_resource)(HPushButton *p_Me, char *pc_image_name);
	...
	* Return : 
	************************************************************************/
	void			(*set_image_from_buffer)(HPushButton *p_Me, VMUINT8 *pi_buf, VMINT i_size);
	...
	* Return : 
	************************************************************************/
	void			(*clean_bgimage)(HPushButton *p_Me);
